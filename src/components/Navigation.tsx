...
export default function Navigation() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto w-full px-6 flex items-center justify-between">
          <div className="flex items-center gap-10">
            <Link to="/" className="flex items-center gap-2 group">
              <h1 className="text-2xl font-black tracking-tighter text-neon italic">
              ...
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    to={item.href}
                    className={cn(
                      "text-xs font-black uppercase tracking-widest transition-colors hover:text-neon",
          ...
          <div className="flex items-center gap-6">
            <div className="bg-white/5 px-4 py-1.5 rounded-full text-[10px] font-black flex items-center gap-2 border border-white/10">
      ...
      <nav className="md:hidden flex h-14 items-center justify-between px-6 bg-[#0A0A0B] border-b border-white/5 sticky top-0 z-50">
        <Link to="/" className="flex items-center gap-2">
          <h1 className="text-lg font-black tracking-tighter text-neon italic">
            TARKAM<span className="text-white">ARENA</span>
          </h1>
        </Link>
        <div className="flex items-center gap-4">
          ...
          <Link to="/profile" className={cn(
            ...
            user ? "border-neon bg-neon/10 text-neon" : "border-white/10 text-gray-600"
          )}>
